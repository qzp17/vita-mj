    ...
    internal static class MaterialEditorUtility
    {
            ...
            MaterialProperty channelsXProperty, MaterialProperty multipliedValueProp)
        {
            ...
            if (channelsXProperty != null)
            {
                ...
                GUI.Label(xPropertyLabelRect, NovaLanguage.Get("Channels"));
            ...
            MaterialProperty channelsXProperty, MaterialProperty channelsYProperty)
        {
            ...
            using (new ResetIndentLevelScope())
            {
                ...
                {
                    GUI.Label(labelRect, NovaLanguage.Get("Tiling") );
                    labelRect.y += EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing;
                    GUI.Label(labelRect, NovaLanguage.Get("Offset"));
                }

                if (useOffsetCoord)
                {
                    labelRect.y += EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing;
                    GUI.Label(labelRect, NovaLanguage.Get("Offset Coords"));
                }

                if (useChannels)
                {
                    labelRect.y += EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing;
                    GUI.Label(labelRect, NovaLanguage.Get("Channels"));
                }
        ...
        public class FoldoutHeaderScope : GUI.Scope
        {
            ...
            public FoldoutHeaderScope(bool foldout, string text)
            {
                ...
                GUI.Label(textRect, NovaLanguage.Get(text), _textStyle);
