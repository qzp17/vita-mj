    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if ((this.renderingModeActual == RenderingMode.Deferred && !this.useRenderPassEnabled) || requiresDepthPrepass || requiresDepthCopyPass)
            {
                ...
                depthDescriptor.width = (int)(depthDescriptor.width * UniversalRenderPipeline.asset.depthRenderScale);
                depthDescriptor.height =  (int)(depthDescriptor.height * UniversalRenderPipeline.asset.depthRenderScale);
